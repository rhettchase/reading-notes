...
env_file_path = os.path.join(os.path.dirname(__file__), 'canvas.env')
...
def scrap_code_fellows_reading(str_url:str, str_username:str, str_password:str):
    with sync_playwright() as p:
        ...
        obj_page.locator('xpath=//*[@id="pseudonym_session_unique_id"]').fill(value=str_username)
        obj_page.wait_for_timeout(100)
        obj_page.locator('xpath=//*[@id="pseudonym_session_password"]').fill(value=str_password)
        obj_page.wait_for_timeout(100)
